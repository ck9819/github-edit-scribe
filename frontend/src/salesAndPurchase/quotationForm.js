...
const QuotationForm = () => {
  ...
  const { buyerName } = location.state || {}; 
    ...
    //const { id } = useParams(); // Assuming you are using React Router to get the sales entry ID
    ...
    const columns = [
                  ...
                  <Form layout="vertical">
                    ...
                    <Col span={12}>
                        ...
                        <Form.Item label="Amendment" name="amendment">
                            <Input placeholder="Amendment" value= "" />
                        </Form.Item>
      ...
      />
        ...
        width={'60vw'}
      >
        <h2>Quotation Saved successfuly</h2>
      </Modal>
        </div>
      );
    };
