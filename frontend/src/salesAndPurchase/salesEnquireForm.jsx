...
import { fetchCompany, fetchAllItems, getQuotationNumber} from '../api/index'
  ...
  const { buyerName } = location.state || {}; 
    ...
    useEffect(() => {
      fetchAllItems();
        ...
        setSqNumber(getQuotationNumber());
      }, []);
    ...
    const handleSaveDraft = async () => {
      ...
      const handleSubmit = async (e) => {
          e.preventDefault();
          try {
              const response = await axios.post('http://localhost:5000/sales', formData);
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'totalbeforetax',
            render: (text) => <Input defaultValue={2000} />,
          },
          {
            title: 'Remarks',
            dataIndex: 'remarks',
      ...
      return (
        <div className="container">
          <Card title="Sales Enquiry" bordered={true} className="card-title">
            <Row gutter={16}>
            <Col span={6}>
              ...
              <Col span={24}>
                <Card title="Primary Document Details" bordered={true}>
                  <Form layout="vertical">
                    <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="SE Number" name="seNumber">
                        <Input value="YPE/SE/23-24/00001" disabled />
                        </Form.Item>
                        ...
                        <Form.Item label="POC Name" name="CustomerenquiryNumber">
                            <Input placeholder="Customer Enquiry Number" />
                        </Form.Item>
                    ...
                    <Col span={12}>
                        ...
                        <Form.Item label="POC Contact Number" name="POC Cantact Number">
                            <Input placeholder="POCContactNumber" />
                        </Form.Item>
                    </Col>
                    </Row>
                  </Form>
      ...
      />
                ...
                <Card>
                  <Form layout="vertical">
                    <Form.Item label="Total (before tax)">
                      <Input defaultValue="₹2000.00"  onChange={handleChange}/>
                    </Form.Item>
                    <Form.Item label="Total Tax">
                      <Input defaultValue="₹100.00"  onChange={handleChange} />
                    </Form.Item>
                    <Form.Item label="Total (after tax)">
                      <Input defaultValue="₹2100.00"  onChange={handleChange}/>
                    </Form.Item>
        ...
        width={'60vw'}
      >
        <h2>Enquiry Saved successfuly</h2>
      </Modal>
        </div>
      );
    };
